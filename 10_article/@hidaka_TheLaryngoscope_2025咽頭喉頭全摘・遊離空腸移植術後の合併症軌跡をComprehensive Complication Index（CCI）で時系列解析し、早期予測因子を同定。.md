...
> **PDF**.
> **Link**
> https://doi.org/10.1002/lary.32149

# 1 AI要約
![[90_attachments/hidaka_TheLaryngoscope_2025/infographic.png]]

## AI要約
### **研究の概要**
- 咽頭喉頭全摘・遊離空腸移植術後の合併症軌跡をComprehensive Complication Index（CCI）で時系列解析し、早期予測因子を同定。

### **先行研究との差異および優位性**
- 従来のClavien-Dindo分類では捉えられない合併症の時間的推移をCCIで連続的に評価。重篤合併症の早期同定が可能。

### **研究手法**
- 後向き観察研究（2018-2023年）。TPL+FJT施行161例を対象。術後30日間の日次CCIを追跡。Group-based trajectory modelで軌跡パターンを分類。

### **結果**
- 3つの合併症軌跡を同定：無合併症（80例）、中等度（66例）、重篤（15例）。術後2日目のCCI≥8.7で重篤軌跡を高精度予測（AUC 0.926）。

### **考察および課題**
- CCIによる早期リスク層別化により標的介入が可能。重篤合併症軌跡の早期同定は患者転帰改善に寄与する可能性。

### **キーワード**
#total_pharyngolaryngectomy, #free_jejunal_transfer, #complication_trajectory, #comprehensive_complication_index, #early_prediction
...
# 2 Citation
Hidaka, Takeaki and Miyamoto, Shimpei and Fukunaga, Yutaka and Oshima, Azusa and Shinozaki, Takeshi and Matsuura, Kazuto and Higashino, Takuya. Complication Trajectories in Total Pharyngolaryngectomy: Comprehensive Complication Index Analysis. The Laryngoscope. 2025;135:3186--3192.
