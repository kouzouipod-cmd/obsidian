...
## AI要約
### **研究の概要**
- 大規模軟部組織欠損の腫瘍再建において、250cm²を超える拡張前外側大腿皮弁の使用を検討した後向き研究。

### **先行研究との差異および優位性**
- 単一施設での最大規模の拡張前外側大腿皮弁症例シリーズであり、従来の250cm²制限を超える大型皮弁の安全性を実証。

### **研究手法**
- 後向き症例シリーズ研究。2018年4月から2022年12月に250cm²を超える前外側大腿皮弁移植を施行した症例を対象。手術データと結果を解析。

### **結果**
- 38皮弁（36症例）を対象。平均皮膚パドルサイズは363±101cm²（範囲250-660cm²）。全皮弁生着を達成。合併症は創離開4例、感染3例、血腫2例。

### **考察および課題**
- 250cm²を超える大型皮弁も2-4本の穿通枝で安全に挙上可能。特別な技術や追加血管吻合を要さず、腫瘍性大型欠損に有用。

### **キーワード**
#anterolateral_thigh_flap, #extended_flap, #oncologic_reconstruction, #soft_tissue_defect, #perforator_flap
...
# 2 Citation
Furuse, Kiichi and Kageyama, Daisuke and Arikawa, Masaki and Akazawa, Satoshi and Higashino, Takuya. Extended Anterolateral Thigh Flaps: Maximum Size for Covering Cancerous Defects. Annals of Plastic Surgery. 2025;94:670.

# 3 Related
>[!Info]
> **FirstAuthor**:: Furuse, Kiichi
