...
遊離皮弁移植術後に静脈内ヘパリンを投与するかどうかは、施設によって異なる経験則で決まっている場合が多い。京都府立医科大学が頭頸部癌の切除・再建を受けた**206例**を3群に分けて前向きに比較した。A群（皮弁再建＋ヘパリン5000〜10000単位/日、術後7日間）、B群（皮弁再建のみ）、C群（頸部郭清・切除のみ）である。

**PT-INRとAPTTはA群で1.3〜1.5倍、B群で1.3倍延長した。** しかし皮弁生着率はA群・B群ともに有意差がなかった。A群では**血腫の発生率のみが有意に増加した（p=0.04）**。出血量・再手術率・血栓塞栓症の発生率に群間差はなかった。

この結果が示すのは、「低用量ヘパリンは凝固時間を延ばすが、皮弁生着率を改善するエビデンスはなく、むしろ血腫リスクを上げる」ということである。遊離皮弁の血栓予防として日常的にヘパリンを使っている施設にとって、このデータは再考を促す根拠になる。ただし単一施設の観察期間が短い研究であり、最適な抗凝固プロトコールの確立には多施設研究が必要とされる。

## AI要約
### **研究の概要**
- 頭頸部マイクロ血管再建における全身低用量未分画ヘパリン投与が遊離皮弁転帰に与える影響を検討した206例の前向き比較研究。

### **先行研究との差異および優位性**
- ヘパリン使用群と非使用群の直接比較に加え、皮弁再建なしの群も含めた3群比較を実施。凝固時間マーカー（PT-INR、APTT）の経時的変化を詳細に測定し、血腫形成への影響を明確に示した点が新規性。

### **研究手法**
- 研究デザイン：前向き比較研究。対象：頭頸部癌根治術を受けた206例を3群に分類（A群：皮弁再建＋ヘパリン、B群：皮弁再建単独、C群：根治術単独）。主要評価項目：皮弁生着率、出血、血腫、血栓塞栓症。凝固時間測定：術前、POD1、3、7。

### **結果**
- 皮弁生着率：ヘパリン使用による有意差なし。PT-INR/APTT：A群で1.3-1.5倍延長、B群で1.3倍延長。血腫発生率：A群で有意に増加（p=0.04）。出血、再手術、血栓塞栓症の発生率に群間差なし。

### **考察および課題**
- 低用量ヘパリンは血腫形成を増加させるが皮弁失敗率に影響しない。マイクロ血管皮弁生存に対するヘパリンの保護効果は証明されず。Limitation：単一施設研究、観察期間が短期。今後の課題：最適な抗凝固療法プロトコールの確立、長期合併症の評価。

### **キーワード**
#heparin, #free-flap, #microvascular-surgery, #anticoagulation, #head-neck-reconstruction
...
# 2 Citation
Numajiri, Toshiaki and Sowa, Yoshihiro and Nishino, Kenichi and Arai, Akihito and Tsujikawa, Takahiro and Ikebuchi, Kaichiro and Nakano, Hiroshi and Sakaguchi, Hirofumi. Use of Systemic Low-Dose Unfractionated Heparin in Microvascular Head and Neck Reconstruction: Influence in Free-Flap Outcomes. Journal of Plastic Surgery and Hand Surgery. 2016;50:135-141.

# 3 Related
>[!Info]
> **FirstAuthor**:: Numajiri, Toshiaki
> **Title**: Use of Systemic Low-Dose Unfractionated Heparin in Microvascular Head and Neck Reconstruction: Influence in Free-Flap Outcomes
> **Year**: 2016
> **Citekey**: numajiri_J.Plast.Surg.HandSurg._2016
