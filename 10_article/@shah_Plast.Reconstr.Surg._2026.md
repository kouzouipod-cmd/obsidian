...
> **PDF**.
> **Link**
> https://doi.org/10.1097/PRS.0000000000012471

# 1 AI要約
![[90_attachments/shah_Plast.Reconstr.Surg._2026/infographic.png]]

## AI要約

### **研究の概要**
- 手根管症候群に対する超音波ガイド下手根管開放術（USCTR）の有効性と安全性を従来の開放手術と比較したシステマティックレビューとメタ解析。

### **先行研究との差異および優位性**
- USCTRは低侵襲的な代替手術法として注目されているが、従来の開放手術との包括的比較が不足していた。本研究は43の研究、4097症例を含む大規模なメタ解析により、客観的な比較評価を提供した。

### **研究手法**
- システマティックレビューとメタ解析。PubMed、Embase、ScienceDirect、CENTRALデータベースを検索。Cochrane risk-of-bias、Newcastle Ottawa、Joanna Briggs Institute toolsを用いたバイアス評価を実施。機能的アウトカム、神経伝導検査、患者報告アウトカム、合併症、再手術率を評価項目として設定。

### **結果**
- USCTRと開放手術間で運動潜時、感覚神経伝導速度、合併症率に有意差なし。USCTRでは職場復帰が10.15日早く（P=0.02）、日常生活復帰が21日早い（P<0.001）。USCTR合併症率1.57%、再手術率0.34%と良好。

### **考察および課題**
- USCTRは安全で効果的な代替手術法であり、回復時間短縮と早期職場復帰という利点を有する。Limitationとして大規模前向き研究が必要。手根管症候群治療におけるUSCTRの役割をさらに評価することが今後の課題。

### **キーワード**
#carpal_tunnel_syndrome, #ultrasound_guided_surgery, #minimally_invasive, #systematic_review, #meta_analysis
...
# 2 Citation
Shah, Pushti and Parise, Suhas and Saffari, Tiam M. and Noorbakhsh, Seth and Ignatiuk, Ashley. Efficacy and Safety of Ultrasound-Guided Carpal Tunnel Release: A Systematic Review and Meta-Analysis. Plastic and Reconstructive Surgery. 2026;157:875.

# 3 Related
>[!Info]
> **FirstAuthor**:: Shah, Pushti
