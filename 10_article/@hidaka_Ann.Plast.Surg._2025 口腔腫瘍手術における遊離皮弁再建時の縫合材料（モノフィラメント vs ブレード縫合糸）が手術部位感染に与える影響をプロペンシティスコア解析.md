...
> **PDF**.
> **Link**
> https://doi.org/10.1097/SAP.0000000000004191

# 1 AI要約
![[90_attachments/hidaka_Ann.Plast.Surg._2025/infographic.png]]

## AI要約
### **研究の概要**
- 口腔腫瘍手術における遊離皮弁再建時の縫合材料（モノフィラメント vs ブレード縫合糸）が手術部位感染に与える影響をプロペンシティスコア解析で検討。

### **先行研究との差異および優位性**
- 口腔腫瘍・遊離皮弁再建における縫合材料の感染リスクを検討した初の研究であり、プロペンシティスコア解析により選択バイアスを調整。

### **研究手法**
- 後向きコホート研究（2020年5月-2024年4月）。主要評価項目は口腔SSI発生率。多変量ロジスティック回帰とIPTW法によるプロペンシティスコア解析を実施。

### **結果**
- 209例中58例（27.8%）にSSI発生。ブレード縫合糸群（42.9%）はモノフィラメント群（24.7%）と比較してSSI率が高く、リスク差18.5%。

### **考察および課題**
- ブレード縫合糸は口腔再建においてSSIリスクを増加させる。特に口底再建ではモノフィラメント縫合糸が推奨される。

### **キーワード**
#surgical_site_infection, #suture_materials, #oral_oncology, #free_flap_reconstruction, #propensity_score
...
# 2 Citation
Hidaka, Takeaki and Miyamoto, Shimpei and Furuse, Kiichi and Fukunaga, Yutaka and Oshima, Azusa and Shinozaki, Takeshi and Matsuura, Kazuto and Wakabayashi, Masashi and Higashino, Takuya. Impact of Suture Materials on Surgical Site Infection in Oral Oncological Surgery With Free-Flap Reconstruction: Analysis Using Propensity Scores. Annals of Plastic Surgery. 2025;94:325.
